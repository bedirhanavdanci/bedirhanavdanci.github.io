...
page-title: false
---
<h1 class="visually-hidden">Bedirhan Avdancı</h1>
    ...
    <div class="social-links">
      <a href="https://x.com/bedirhan_avd" class="social-icon" target="_blank" aria-label="X (Twitter)">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.656l-5.214-6.817 -5.966 6.817H1.684l7.73-8.835 L1.25 2.25h6.824l4.713 6.231 5.457-6.231Zm-1.16 17.52h1.833 L6.08 4.126H4.114l12.97 15.644Z"/>
        </svg>
      </a>
      ...
      <a href="https://scholar.google.com/citations?user=jAF-BsgAAAAJ&hl=tr" class="social-icon" target="_blank" aria-label="Google Scholar">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M12 24a7 7 0 1 1 0-14 7 7 0 0 1 0 14zm0-24L0 9.5l4.852 3.639a7.002 7.002 0 0 1 14.296 0L24 9.5 12 0z"/>
        </svg>
      </a>

      <a href="https://www.researchgate.net/profile/Bedirhan-Avdanci" class="social-icon" target="_blank" aria-label="ResearchGate">
        <svg width="32px" height="32px" viewBox="5 5 22 22" xmlns="http://www.w3.org/2000/svg">
